...
export const observatoryUrl = "https://observatorioturismo.pi.gov.br/turismo_numeros/";
export const deltaSourceUrl = "https://www.gov.br/icmbio/pt-br/assuntos/biodiversidade/unidade-de-conservacao/unidades-de-biomas/marinho/lista-de-ucs/apa-delta-do-parnaiba/informacoes-sobre-visitacao-apa-delta-do-parnaiba";
export const seteCidadesUrl = "https://www.gov.br/icmbio/pt-br/assuntos/biodiversidade/unidade-de-conservacao/unidades-de-biomas/caatinga/lista-de-ucs/parna-de-sete-cidades";
export const confusoesUrl = "https://www.gov.br/icmbio/pt-br/assuntos/biodiversidade/unidade-de-conservacao/unidades-de-biomas/caatinga/lista-de-ucs/parna-da-serra-das-confusoes";
...
export type Category = "Natureza" | "Patrimônio" | "Litoral" | "Cultura" | "Cidade";
export type Region = "Polo Teresina" | "Aventura e Mistério" | "Costa do Delta" | "Águas" | "Nascentes" | "Origens" | "Histórico Cultural";
