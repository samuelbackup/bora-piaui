...
export const pilotCities: PilotCity[] = [
  {
    ...
    summary:
      "Uma cidade de rios, encontros e deslocamentos que conectam o visitante aos demais percursos do estado.",
    accent: "#2E6C76",
  ...
  },
  {
    ...
    summary:
      "Mar, mangue e experiências que dependem das condições de maré e da confirmação local.",
    accent: "#D9A640",
    source: deltaSource,
  },
  {
    ...
    summary:
      "Uma base para conhecer a paisagem arqueológica e os sítios da Serra da Capivara com planejamento prévio.",
    accent: "#B9572D",
...
export const pilotItems: PilotItem[] = [
  {
    ...
    summary:
      "Uma porta de entrada urbana no encontro entre os rios Poti e Parnaíba.",
    image: {
  ...
  },
  {
    ...
    summary:
      "Um percurso de cerâmica e memória local, conectado às tradições do bairro Poti Velho.",
    image: {
    ...
    routeUrl:
      "https://www.google.com/maps/dir/?api=1&destination=Polo%20Ceramico%20do%20Poti%20Velho%2C%20Teresina%2C%20PI",
  ...
  },
  {
    ...
    category: "Cidade e paisagem",
    summary:
      "Referência da paisagem urbana de Teresina, o complexo reúne o mirante associado à Ponte Estaiada.",
    image: {
      ...
      licenseUrl:
        "https://commons.wikimedia.org/wiki/File:Ponte_Estaiada_-_Teresina.jpg",
    },
    routeUrl:
      "https://www.google.com/maps/dir/?api=1&destination=Complexo%20Tur%C3%ADstico%20Ponte%20Estaiada%2C%20Teresina%2C%20PI",
  ...
  },
  {
    ...
    summary:
      "Teatro histórico de Teresina e uma referência para as artes cênicas do Piauí.",
    image: {
      ...
      licenseUrl:
        "https://commons.wikimedia.org/wiki/File:Theatro_4_de_setembro_predio.JPG",
    },
    routeUrl:
      "https://www.google.com/maps/dir/?api=1&destination=Theatro%204%20de%20Setembro%2C%20Teresina%2C%20PI",
  ...
  },
  {
    ...
    summary:
      "Espaço cultural de Teresina associado à memória e aos acervos sobre o Piauí.",
    image: {
      ...
      license: "CC BY 3.0 BR",
      licenseUrl:
        "https://commons.wikimedia.org/wiki/File:Museu_do_Piau%C3%AD_pr%C3%A9dio.JPG",
    },
    routeUrl:
      "https://www.google.com/maps/dir/?api=1&destination=Museu%20do%20Piau%C3%AD%20Casa%20de%20Odilon%20Nunes%2C%20Teresina%2C%20PI",
  ...
  },
  {
    ...
    summary:
      "Parque urbano incluído pela SEMDEC entre os equipamentos de lazer de Teresina.",
    image: {
    ...
    routeUrl:
      "https://www.google.com/maps/dir/?api=1&destination=Parque%20Potycabana%2C%20Teresina%2C%20PI",
    externalUrl: semdecTeresinaTourismSource.url,
  ...
  },
  {
    ...
    category: "História e artesanato",
    summary:
      "Referência de artesanato em Teresina, incluída pela SEMDEC entre os equipamentos turísticos da cidade.",
    image: {
      ...
      license: "Domínio público",
      licenseUrl:
        "https://commons.wikimedia.org/wiki/File:Central_de_Artesanato_Mestre_Dezinho_(Esperan%C3%A7a_Garcia).jpg",
    },
    routeUrl:
      "https://www.google.com/maps/dir/?api=1&destination=Central%20de%20Artesanato%20Mestre%20Dezinho%2C%20Teresina%2C%20PI",
    externalUrl: semdecTeresinaTourismSource.url,
  ...
  },
  {
    ...
    category: "Litoral",
    summary:
      "Mar, mangue e percursos guiados pelo ritmo da maré no litoral piauiense.",
    routeUrl:
  ...
  },
  {
    ...
    category: "Patrimônio",
    summary:
      "Arqueologia, paisagem e um Patrimônio Mundial no sudeste do Piauí.",
    routeUrl:
  ...
  },
  {
    ...
    summary:
      "Uma atração do município que amplia a descoberta do litoral para além da praia de Barra Grande.",
    routeUrl:
      "https://www.google.com/maps/dir/?api=1&destination=Cajueiro%20Rei%20do%20Piau%C3%AD%2C%20Cajueiro%20da%20Praia%2C%20PI",
  ...
  },
  {
    ...
    summary:
      "Espaço da FUMDHAM dedicado a divulgar o patrimônio cultural e pesquisas realizadas na região da Serra da Capivara.",
    routeUrl:
      "https://www.google.com/maps/dir/?api=1&destination=Museu%20do%20Homem%20Americano%2C%20S%C3%A3o%20Raimundo%20Nonato%2C%20PI",
...
export const pilotProximityRelations: PilotProximityRelation[] = [
  {
    ...
    category: "História e artesanato",
    editorialReason:
      "Uma continuidade territorial para conhecer a cerâmica, as tradições do Poti Velho e as narrativas ligadas ao encontro dos rios.",
    source: potiVelhoSource,
  },
  {
    ...
    category: "Natureza e memória",
    editorialReason:
      "Uma continuidade territorial para conhecer uma atração municipal que amplia o recorte de litoral de Barra Grande.",
    source: cajueiroMunicipalSource,
  },
  {
    ...
    category: "Memória e arqueologia",
    editorialReason:
      "Um complemento editorial para contextualizar o patrimônio cultural e as pesquisas da região da Serra da Capivara.",
    source: fumdhamMuseumSource,
  },
];
...
export const pilotCurationTopics: PilotCurationTopic[] = [
  {
    ...
    description:
      "Restaurantes e pontos de alimentação só serão indicados após fonte, canal público e confirmação editorial.",
    status: "curating",
  },
  {
    ...
    description:
      "Informações de apoio ao visitante serão incluídas quando houver canal oficial e condição operacional confirmada.",
    status: "curating",
  },
  {
    ...
    description:
      "A interface não nomeia restaurantes ou condições de atendimento sem publicação editorial e canal confirmado.",
    status: "curating",
  },
  {
    ...
    description:
      "Passeios, apoio e demais serviços serão exibidos somente após confirmação de operação e fonte pública.",
    status: "curating",
  },
  {
    ...
    description:
      "A descoberta não indica estabelecimentos sem fonte, contato publicado e confirmação editorial.",
    status: "curating",
  },
  {
    id: "serra-servicos",
    ...
    title: "Serviços de visita em curadoria",
    description:
      "Condução, transporte e apoio à visita dependem de informações públicas atualizadas e confirmação operacional.",
    status: "curating",
  },
];
...
export const curatedBusinesses: CuratedBusiness[] = [
  {
    ...
    summary:
      "Canal institucional para orientar o visitante antes de organizar a visita à Serra da Capivara.",
...
export const pilotEditorialHighlights: PilotEditorialHighlight[] = [
  {
    ...
    title: "Cultura",
    description:
      "Tradições nordestinas, patrimônio local e artesanato piauiense compõem a cena cultural da capital. O Polo Cerâmico de Teresina é uma das referências desse percurso.",
  ...
  },
  {
    ...
    title: "História",
    description:
      "Fundada em 1852 como capital do Piauí e concebida como cidade planejada, Teresina se desenvolveu na confluência dos rios Poti e Parnaíba.",
    source: g20TeresinaSource,
  },
  {
    ...
    title: "Cultura",
    description:
      "A pesca artesanal aparece na história municipal como prática associada à herança dos Tremembé e exercida pela população local.",
    source: cajueiroMunicipalSource,
  },
  {
    ...
    title: "História",
    description:
      "A origem do nome do município é ligada aos cajueiros nativos; o portal municipal registra sua fundação em 15 de dezembro de 1995.",
    source: cajueiroMunicipalSource,
  },
  {
    ...
    title: "Cultura",
    description:
      "São Raimundo Nonato integra o conjunto de municípios parcialmente abrangidos pela Serra da Capivara, onde registros rupestres preservam evidências de antigas comunidades humanas na América do Sul.",
    source: capivaraSource,
  },
  {
    ...
    title: "História",
    description:
      "O histórico municipal registra a formação administrativa que elevou São Raimundo Nonato à condição de cidade em 1912.",
...
export const pilotItineraries: PilotItinerary[] = [
  {
    ...
    summary:
      "Um roteiro inicial para começar pelo Encontro dos Rios e decidir os próximos deslocamentos com dados atualizados.",
    confirmationNotice:
      "As próximas paradas, horários e condições precisam ser confirmados antes da saída.",
  ...
  },
  {
    ...
    durationLabel: "Operação a confirmar",
    summary:
      "Um ponto de partida para planejar a costa, sempre respeitando maré, condução e avisos locais.",
    confirmationNotice:
      "A operação de passeios e os horários variam. Confirme antes de organizar o deslocamento.",
  ...
  },
  {
    ...
    durationLabel: "Operação a confirmar",
    summary:
      "Uma estrutura inicial para organizar a visita sem presumir disponibilidade de circuitos ou serviços.",
    confirmationNotice:
      "Consulte as regras de visitação, condução e operação do parque antes de fechar o roteiro.",
...
export function getPilotCity(
  slug: string,
  catalog: PilotCatalog = pilotCatalog
) {
  return catalog.cities.find(city => city.slug === slug) ?? null;
}

export function getPilotItems(
  citySlug: string,
  kind: PilotItemKind | "all" = "all",
  category = "all",
  catalog: PilotCatalog = pilotCatalog
) {
...
export function getPilotItinerary(
  citySlug: string,
  catalog: PilotCatalog = pilotCatalog
) {
  return (
    catalog.itineraries.find(itinerary => itinerary.citySlug === citySlug) ??
    null
  );
}
...
export function getPilotNearbyItems(
  anchorItemId: string,
  catalog: PilotCatalog = pilotCatalog
) {
  return catalog.proximityRelations
    ...
    .map(relation => ({
      relation,
      item: getPilotItem(relation.relatedItemId, catalog),
    }))
    .filter(
      (entry): entry is { relation: PilotProximityRelation; item: PilotItem } =>
        entry.item !== null && entry.item.status === "published"
    );
}

export function getPilotCurationTopics(
  citySlug: string,
  catalog: PilotCatalog = pilotCatalog
) {
...
export function getPilotCuratedBusinesses(
  citySlug: string,
  kind: CuratedBusinessKind,
  catalog: PilotCatalog = pilotCatalog
) {
  return catalog.curatedBusinesses.filter(
    entry =>
...
export function getPilotFoodOptions(
  citySlug: string,
  anchorItemId: string,
  catalog: PilotCatalog = pilotCatalog
) {
  return getPilotCuratedBusinesses(citySlug, "restaurant", catalog).filter(
    entry => entry.anchorItemIds?.includes(anchorItemId)
  );
}

export function getPilotEditorialHighlights(
  citySlug: string,
  catalog: PilotCatalog = pilotCatalog
) {
  return catalog.editorialHighlights.filter(
    entry => entry.citySlug === citySlug
  );
}

export function getPilotCategories(
  citySlug: string,
  kind: PilotItemKind | "all" = "all",
  catalog: PilotCatalog = pilotCatalog
) {
  return Array.from(
    new Set(
      getPilotItems(citySlug, kind, "all", catalog).map(item => item.category)
    )
