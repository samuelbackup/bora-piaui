      ...
      <header className="sticky top-0 z-40 border-b border-[#3C482D]/10 bg-[#F5ECD8]/92 backdrop-blur-xl">
        <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-5 text-xs font-bold lg:flex xl:gap-6 xl:text-sm">
            ...
            <Link href="/parceiros" className="tap text-[#B9572D] hover:text-[#3C482D]">Seja parceiro</Link>
