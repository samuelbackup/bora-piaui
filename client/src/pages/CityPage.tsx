...
import { getPilotCategories, getPilotCity, getPilotCurationTopics, getPilotEditorialHighlights, getPilotFoodOptions, getPilotItem, getPilotItems, getPilotItinerary, getPilotNearbyItems, loadPilotCatalog, type PilotCatalog, type PilotItemKind } from "@/lib/mvpPilot";
...
export default function CityPage() {
  ...
  useEffect(() => {
    ...
    const requestedFoodAnchor = requestedFoodAnchorId && catalog ? getPilotItem(requestedFoodAnchorId, catalog) : null;
