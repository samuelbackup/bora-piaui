...
- [x] Proteger todas as operações editoriais demonstrativas com `adminProcedure` e impedir leitura pública de rascunhos.
- [x] Atualizar os testes de autorização para visitantes, usuários comuns e administradores.
- [x] Reduzir a home e a navegação pública ao Polo Origens: São Raimundo Nonato e Coronel José Dias.
- [x] Remover da interface pública o recorte estadual, as cidades fora de escopo e a monetização do Plano Destaque.
- [x] Eliminar os cartões com fallback “NO IMAGE AVAILABLE” da jornada pública e revisar as mídias de Origens.
- [x] Definir uma publicação Vercel segura enquanto a API externa não estiver disponível.
- [ ] Validar escopo, segurança, acessibilidade, responsividade e publicação em staging e produção.
